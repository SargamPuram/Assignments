''' 
Write a Python program to store names and mobile numbers of your friends in sorted order on names. Search your friend from list using binary search (recursive and non- recursive). Ins
'''
...
def binarysearch(name, start, end):
    if start <= end:
        ...
        print("Entered name and phone number don't exist in the phonebook")
...
print("After adding new details in phonebook at the correct position:")
print("Names present in the phonebook:")
print(name)
print("Phone numbers present in the phonebook:")
print(phone)
